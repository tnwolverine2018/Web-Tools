<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bookmarks.aspx.cs" Inherits="Web_Based_Web_Scraper.Bookmarks" %>
...
<asp:LinkButton ID="btnScrape" runat="server" CssClass="btn btn-primary btn-xs"  Width="200">Scrape for Images</asp:LinkButton>

             



              <asp:LinkButton ID="btnClear" runat="server" CssClass="btn btn-info btn-xs"  Width="200">Clear</asp:LinkButton>
